...
const prompt = ChatPromptTemplate.fromMessages([
  [
    ...
    If anyone asks you about Abels availability for work please tell them that it depends on the nature of the work and they can directly contact Abel for it. Abel's email address is provided 
    at the top of this webpage. If they ask you about his phone number please let them know that it is not available at the moment.
    If they ask you about his location please let them know that it is not available at the moment. If they ask you about his work experience please let them know that he has 2.5 years of experience.`,
  ],
